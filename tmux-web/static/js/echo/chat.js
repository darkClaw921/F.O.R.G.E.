...
/**
 * Минимальный markdown-renderer: code fences (```...```), inline `code`,
 * **bold**, *italic*, заголовки (#, ##, ###), bullet-списки, ссылки [text](url).
 * Не XSS-safe для произвольного HTML — мы строим DOM, не innerHTML, поэтому
 * пользовательские data не уходят в innerHTML кроме внутри <code>/<pre>.
 */
